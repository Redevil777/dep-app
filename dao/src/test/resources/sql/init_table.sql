insert into users (id, username, password, enabled) VALUES (1, 'user','pass', 1), (2, 'admin', 'admin', 1);
...
INSERT INTO department (id, dep_name, create_at, update_at, enabled, create_by, update_by) VALUES (1, 'java developer', '1970-01-01','1970-01-01',1,1, 1), (2, 'c++ developer', '1970-01-01','1970-01-01',1,1, 1),  (3, 'python developer', '1970-01-01','1970-01-01',1,1, 1),  (4, 'objective-c developer', '1970-01-01','1970-01-01',1,1, 1);
